...
render() {  
    return (  
        <div>  
            ...
            <input type="text" id="qualification" onChange={this.changeQualification.bind(this)}/>  
            <br/>
            <label htmlFor="City">Enter City</label>
            <input type="text" id="city" onChange={this.changeCity.bind(this)} />
            <br/>
            <label htmlFor="mi">Enter State</label>
            <input type="text" id="state" onChange={this.changeState.bind(this)} />            
